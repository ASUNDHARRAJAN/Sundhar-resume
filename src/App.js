...
<h6 style={{fontSize:"1.15rem"}}>FRONTEND TECHNOLOGIES</h6>
<div class="row">
...
<h6 style={{fontSize:"1.15rem"}}>BACKEND TECHNOLOGIES</h6>
<div class="row">
<div class="col-md-1"></div>
...
<section class="experience_background">
                ...
                <div class="container">
                 <table class="table">
                      <tbody>
                        <tr>
                          <td>December 2019 to Present</td>
                          <td><b>Web Developer</b><br></br>
                          SearchNScore Solutions Coimbatore, Tamilnadu.</td>                      
                        </tr>
                        <tr>
                          <td>September 2018 to November 2019</td>
                          <td><b>SAP Business ByDesign Consultant and Web Developer</b><br></br>
                          Nipurna IT Solutions Private Limited Salem, Tamilnadu.</td>                        
                        </tr>
                        <tr>
                  ...
                  <ul class="container">
                    <li>Web Developer Boot Camp (<b>HTML5, Bootstrap4, CSS3, JavaScript, JQuery</b>) – Udemy</li>
